...
class CoColumnFix_1425971951  extends LazyRecord\Migration\Migration {

    public function upgrade() {
        $this->executeSql('ALTER TABLE measures CHANGE COLUMN c0 co double');
    }

    public function downgrade() {
        $this->executeSql('ALTER TABLE measures CHANGE COLUMN co c0 double');
    }
